    ...
    <section class="sidebar mt-10">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if (is_admin()): ?>
          ...
          <li class="treeview <?php if(isset($main_page) && $main_page == "Settings"){echo "active";} ?>">
            ...
            <ul class="treeview-menu">
                ...
                <li class="<?php if(isset($page_title) && $page_title == "License"){echo "active";} ?>">
          ...
          <li class="treeview <?php if(isset($page_title) && $page_title == "Affiliate " || isset($page) && $page == "Affiliate"){echo "active";} ?> <?= $uval; ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php if(isset($page_title) && $page_title == "Referral_Settings"){echo "active";} ?>">
                <a href="<?php echo base_url('admin/referral/settings') ?>">
                  <i class="icon-settings"></i> <?php echo trans('affiliate') ?> <?php echo trans('settings') ?>
                </a>
              </li>
              <?php if (affiliate_settings()->is_enable == 1): ?>
                <li class="<?php if(isset($page_title) && $page_title == "Payout Request"){echo "active";} ?>">
                  <a href="<?php echo base_url('admin/referral/payout_request') ?>">
                    <i class="icon-credit-card" aria-hidden="true"></i> <?php echo trans('payout-request') ?>
                  </a>
                </li>
                <li class="<?php if(isset($page_title) && $page_title == "Completed Payout"){echo "active";} ?>">
                  <a href="<?php echo base_url('admin/referral/completed_payout') ?>">
                    <i class="icon-check" aria-hidden="true"></i> <?php echo trans('completed') ?>
                  </a>
                </li>
              <?php endif; ?>
            </ul>
          ...
          <li class="treeview <?php if(isset($page) && $page == "Blog"){echo "active";} ?>">
            ...
            <ul class="treeview-menu">
              ...
              <li class="<?php if(isset($page_title) && $page_title == "Blog Posts"){echo "active";} ?>"><a href="<?php echo base_url('admin/blog') ?>"><?php echo trans('blog-posts') ?></a></li>
            </ul>
          </li> 
        ...
        <?php if (check_payment_status() == TRUE || settings()->enable_paypal == 0 || user()->user_type == 'trial'): ?>
          ...
          <li class="treeview <?php if(isset($main_page) && $main_page == "Hrm"){echo "active";} ?>">
            ...
            <ul class="treeview-menu">
                ...
                <li class="<?php if(isset($page_title) && $page_title == "Hrm settings hour"){echo "active";} ?>">
        ...
        <?php endif; ?>
          ...
          <?php if (is_admin()): ?>
            <?php if (file_exists(APPPATH.'controllers/addons/Razorpay.php')): ?>
              <li class="treeview <?php if(isset($main_page) && $main_page == "Addons"){echo "active";} ?> d-none">
