...
CREATE TABLE `business` (
  ...
  `estimate_footer_note` mediumtext,
  `invoice_title` varchar(255) DEFAULT NULL,
  `invoice_summary` text,
  `estimate_title` varchar(255) DEFAULT NULL,
...
(759, 'user', 'Summary', 'summary', 'Summary'),
(760, 'user', 'Set default footer note for estimate', 'set-default-footer-note-for-estimate', 'Set default footer note for estimate'),
(761, 'admin', 'Reset Password', 'reset-password', 'Reset Password'),
(762, 'admin', 'HRM', 'hrm', 'HRM'),
(763, 'admin', 'Department', 'department', 'Department'),
(764, 'admin', 'Edit department', 'edit-department', 'Edit Department'),
(765, 'admin', 'Add new department', 'add-new-department', 'Add new department'),
(766, 'admin', 'Departments', 'departments', 'Departments'),
(767, 'admin', 'Department name', 'department-name', 'Department name'),
(768, 'admin', 'Show', 'show', 'Show'),
(769, 'admin', 'Hide', 'hide', 'Hide'),
(770, 'admin', 'Employees', 'employee', 'Employees'),
(771, 'admin', 'Employees', 'employees', 'Employees'),
(772, 'admin', 'Edit employee', 'edit-employee', 'Edit employee'),
(773, 'admin', 'Add new employee', 'add-new-employee', 'Add new employee'),
(774, 'admin', 'Employee name', 'employee-name', 'Employee name'),
(775, 'admin', 'Image', 'image', 'Image'),
(776, 'admin', 'Attendence', 'attendence', 'Attendance'),
(777, 'admin', 'Edit attendence', 'edit-attendence', 'Edit attandence'),
(778, 'admin', 'Check in', 'check-in', 'Check in'),
(779, 'admin', 'Check out', 'check-out', 'Check out'),
(780, 'admin', 'Note', 'note', 'Note'),
(781, 'admin', 'Add new attendence', 'add-new-attendence', 'Add new attendence'),
(782, 'admin', 'Salary', 'salary', 'Salary'),
(783, 'admin', 'Add new salary', 'add-new-salary', 'Add new salary'),
(784, 'admin', 'Edit salary', 'edit-salary', 'Edit salary'),
(785, 'admin', 'Acount', 'acount', 'Account'),
(786, 'admin', 'Method', 'method', 'Method'),
(787, 'admin', 'Cash', 'cash', 'Cash'),
(788, 'admin', 'Check', 'check', 'Check'),
(789, 'admin', 'Card', 'card', 'Card'),
(790, 'admin', 'Hrm settings', 'hrm-settings', 'HRM Settings'),
(791, 'admin', 'Default check in', 'default-check-in', 'Default check in'),
(792, 'admin', 'Default check out', 'default-check-out', 'Default check out'),
(793, 'admin', 'Withdrawal Method', 'withdrawal-method', 'Withdrawal Method'),
(794, 'admin', 'Withdrawal Amount', 'withdrawal-amount', 'Withdrawal Amount'),
(795, 'admin', 'Balance', 'balance', 'Balance'),
(796, 'admin', 'Transaction Id', 'transaction-id', 'Transaction Id'),
(797, 'admin', 'Request Sent', 'request-sent', 'Request Sent'),
(798, 'admin', 'Total Referrals', 'total-referrals', 'Total Referrals'),
(799, 'admin', 'Total Earnings', 'total-earnings', 'Total Earnings'),
(800, 'admin', 'Total Withdraw', 'total-withdraw', 'Total Withdraw'),
(801, 'admin', 'Minimum Payout Amounts', 'minimum-payout-amounts', 'Minimum Payout Amounts'),
(802, 'admin', 'My Referral URL', 'my-referral-url', 'Referral URL'),
(803, 'admin', 'Referral policy', 'referral-policy', 'Referral policy'),
(804, 'admin', 'First Successful Payment by Referred Person', 'first-successful-payment-by-referred-person', 'First Successful Payment by Referred Person'),
(805, 'admin', 'Every Successful Payment by Referred Person', 'every-successful-payment-by-referred-person', 'Every Successful Payment by Referred Person'),
(806, 'admin', 'Referral guidelines', 'referral-guidelines', 'Referral guidelines'),
(807, 'admin', 'How It works', 'how-it-works', 'How It works'),
(808, 'admin', 'Send Invitation', 'send-invitation', 'Send Invitation'),
(809, 'admin', 'Send your referral link to your friends and tell them how cool is this', 'send-your-referral-link-to-your-friends-and-tell-them-how-cool-is-this', 'Send your referral link to your friends and tell them how cool is this'),
(810, 'admin', 'Registration', 'registration', 'Registration'),
(811, 'admin', 'Let them register using your referral link', 'let-them-register-using-your-referral-link', 'Let them register using your referral link'),
(812, 'admin', 'Get Commissions', 'get-commissions', 'Get Commissions'),
(813, 'admin', 'Earn commission for their first subscription plan payments!', 'earn-commission-for-their-first-subscription-plan-payments', 'Earn commission for their first subscription plan payments!'),
(814, 'admin', 'Paypal Email', 'paypal-email', 'Paypal Email'),
(815, 'admin', 'Bank Details', 'bank-details', 'Bank Details'),
(816, 'admin', 'Referrals', 'referrals', 'Referrals'),
(817, 'admin', 'Referrar Id', 'referrar-id', 'Referrar Id'),
(818, 'admin', 'Order Id', 'order-id', 'Order Id'),
(819, 'admin', 'Commision', 'commision', 'Commision'),
(820, 'admin', 'Commision Amount', 'commision-amount', 'Commision Amount'),
(821, 'admin', 'Send Payout Request', 'send-payout-request', 'Send Payout Request'),
(822, 'admin', 'Payouts', 'payouts', 'Payouts'),
(823, 'admin', 'Select your payment method', 'select-your-payment-method', 'Select your payment method'),
(824, 'admin', 'Paypal', 'paypal', 'Paypal'),
(825, 'admin', 'Bank', 'bank', 'Bank'),
(826, 'admin', 'Method Details', 'method-details', 'Method Details'),
(827, 'admin', 'Enable Referral', 'enable-referral', 'Enable Referral'),
(828, 'admin', 'Choose Referral policy', 'choose-referral-policy', 'Choose Referral policy'),
(829, 'admin', 'Commission only on first purchase', 'commission-only-on-first-purchase', 'Commission only on first purchase'),
(830, 'admin', 'Commission on every purchase', 'commission-on-every-purchase', 'Commission on every purchase'),
(831, 'admin', 'Commision Rate(%)', 'commision-rate', 'Commision Rate(%)'),
(832, 'admin', 'Minimum Payout', 'minimum-payout', 'Minimum Payout'),
(833, 'admin', 'Refferal Guidelines', 'refferal-guidelines', 'Referral Guidelines'),
(834, 'admin', 'Payout Request', 'payout-request', 'Payout Request'),
(835, 'admin', 'Completed Payout', 'completed-payout', 'Completed Payout'),
(836, 'admin', 'Affiliate', 'affiliate', 'Affiliate');
